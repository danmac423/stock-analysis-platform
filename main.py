...
from tools.company_news_tool import fetch_company_news
...
stock_sentiment_agent = Agent(
    ...
    goal="Analyse recent Reddit sentiment about a given stock",
    ...
    llm=my_llm,
    tools=[analyse_reddit, fetch_company_news],
    verbose=True,
)
...
task1 = Task(
    description=(
        ...
        "3. Recent news and press releases (1 week).\n"
